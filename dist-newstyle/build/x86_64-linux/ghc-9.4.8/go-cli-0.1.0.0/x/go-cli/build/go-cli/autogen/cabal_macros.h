...
/* package go-cli-0.1.0.0 */
#ifndef VERSION_go_cli
#define VERSION_go_cli "0.1.0.0"
#endif /* VERSION_go_cli */
#ifndef MIN_VERSION_go_cli
#define MIN_VERSION_go_cli(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_go_cli */
...
#define CURRENT_COMPONENT_ID "go-cli-0.1.0.0-inplace-go-cli"
